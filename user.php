...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light text-capitalize main-font-family" style="margin-top:-60px;">
            <div class="container"style="height:120px;">
            
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#show-menu" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
                <a class="navbar-brand" href="index1.php"><img src="imgs/logo1.PNG" alt="#"style="margin-top:-30px;" /></a>

                <div class="collapse navbar-collapse" id="show-menu">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="index1.php"><h4>Home</h4> <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="room.php"><h4>rooms</h4></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="contact.php"><h4>contacts</h4></a>
                        </li>
                        <li class="nav-item  d-flex align-items-center">
                            <button style="height:45px; width:125px; background-color:#cb0000 ;  border: none;" >
                         <a class="nav-link" href="userindex.php" style="color:white; font-size:20px; ">Book Now</a></button>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <form role="form" id="booking" data-toggle="validator">
                ...
                <div class="col-lg-12">
                    ...
                    <?php } else{?>
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                                <a class="btn btn-secondary pull-right" style="border-radius:0%" href="userindex.php">Replan Booking</a>
                            </div>
                            <div class="panel-body">
                                <div class="form-group col-lg-6">
                                    <label>Room Type</label>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-primary" style="border-radius:60px;" href="userindex.php"><i class="fa fa-check-circle"></i></a>
            </div>
        </div>
